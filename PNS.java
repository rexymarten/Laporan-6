...
public class PNS extends Employee {
    ...
    public PNS(String nama, String idKerja, int tahun) {
    ...
    public void displayMessage() {
        ...
        System.out.println("Istri             : " + (super.getIstri() ? "Ya" : "Tidak"));
        ...
        System.out.println("Total Gaji        : " + (getGaji() + getTunjangan() + getTjistri() + getTjanak()));
    }
}
